...
public class SearchableActivity extends ActionBarActivity {
    ...
    private List<Contato> mListAux;
    private List<Contato> mAdapter;



    private com.mikepenz.materialdrawer.model.interfaces.OnCheckedChangeListener OnCheckedChangeListener=new OnCheckedChangeListener(){

        @Override
        public void onCheckedChanged(IDrawerItem iDrawerItem, CompoundButton compoundButton, boolean b) {
            Toast.makeText(SearchableActivity.this, "onCheckedChanged: " + (b ? "true" : "false"), Toast.LENGTH_SHORT).show();
        }
    };
    ...
    public void filterContatos(String q){
        mListAux.clear();
        ...
        for(int i = 0, tamI = mList.size(); i < tamI; i++) {
            if (!mListAux.contains(mList.get(i)) && mList.get(i).getNome().toLowerCase().startsWith(q.toLowerCase())) {
                mListAux.add(mList.get(i));
            }
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headerNavigationLeft= new AccountHeader()
                ...
                .addProfiles(
                        new ProfileDrawerItem().withName("Caike Bispo").withEmail("ck@bispo.com").withIcon(getResources().getDrawable(R.drawable.person_1))
                )
        ...
        navigationDrawerLeft= new Drawer()
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l, IDrawerItem iDrawerItem) {
                        ...
                        if (i == 0) {
                            ...
                            Intent irSobre = new Intent(SearchableActivity.this, About.class);
                ...
                .withOnDrawerItemLongClickListener(new Drawer.OnDrawerItemLongClickListener() {
                    ...
                    public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l, IDrawerItem iDrawerItem) {
                        ...
                        Toast.makeText(SearchableActivity.this, "onItemLongClick: " + i, Toast.LENGTH_SHORT).show();
                        return false;
                    }
                })
                .build();
